                        ...
                        <motion.div variants={slideUp} initial="initial" animate="enter" className={styles.containerQuest}>
                            <div className={styles.quest}>
                                ...
                                <div className={styles.inputQuest}>
                                    <input type="text" name="name" placeholder="Nathan Bitencorte" onChange={(e) => setName(e.target.value)} required />
                                </div>
                            </div>
                            ...
                            <div className={styles.quest}>
                                ...
                                <div className={styles.inputQuest}>
                                    <input type="email" name="email" placeholder="nathan@gmail.com" onChange={(e) => setEmail(e.target.value)} required />
                                </div>
                            </div>
                            ...
                            <div className={styles.quest}>
                                ...
                                <div className={styles.inputQuest}>
                                    <input type="number" name="phone" placeholder="021 9 1234 5678" onChange={(e) => setPhone(e.target.value)} required />
                                </div>
                            </div>
                            ...
                            <div className={styles.quest}>
                                ...
                                <div className={styles.inputQuest}>
                                    <input type="text" name="$Empresa" placeholder="Nathan & Bitencorte" onChange={(e) => setCorpName(e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div className={styles.quest}>
                                ...
                                <div className={styles.inputQuest}>
                                    <input type="text" name="$Area" placeholder="Jurídico, Desenvolvimento, WebDesign..." onChange={(e) => setArea(e.target.value)} required />
                                </div>
                            </div>
                            ...
                            <div className={styles.quest}>
                                ...
                                <div className={styles.inputQuest}>
                                    <input type="text" name="message" placeholder="Olá Patryck, consegue me ajudar..." onChange={(e) => setMessage(e.target.value)} required />
                                </div>
                            </div>
                    ...
                    <div className={styles.containerNav}>
                        <div className={styles.navHeader}>
                            <div className={styles.imageContainer}>
                                <Image fill={true} alt={"image"} src={`/images/perfil_1.jpeg`} />
                            </div>
